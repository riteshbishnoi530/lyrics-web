...
const Header = () => {
  return (
    <nav className="w-full max-w-[1128px] nav-shadow header-shadow rounded-[20px] flex items-center justify-between py-[10px] max-md:flex-wrap max-lg:gap-3 max-sm:gap-2 max-md:px-4 mt-[10px]">
      <a href="/">
        <img
          src="/assets/images/logo.webp"
          alt="logo"
          className="max-w-[135px] max-md:max-w-[100px] md:mx-4"
        />
      </a>
      ...
      <div className="flex items-center gap-5 max-md:gap-3">
        ...
        <button className="md:me-3 bg-[#14191C] text-white font-medium text-sm leading-6 rounded-[9px] border border-[#14191C] hover:bg-white hover:text-[#14191C] transition-all ease-linear duration-200 w-full min-w-[105px] max-sm:min-w-[85px] py-[9px] h-[43px]">
          Sign Up
        </button>
      </div>
      <div className="md:hidden flex items-center rounded-full w-full max-w-full justify-between border border-solid border-[#DBDBF3] ps-[30px] pe-2 max-md:ps-2">
        <input
          type="text"
          placeholder="What do you feel like listening to right now ?"
